var App = (function App() {
  ...
  function packBoxes(e) {
    ...
    * I thought about making a for loop to change every value, but figured this would take more time,
    * particularly with 2 mil books, rather than just doing it inline.
    * Of course, this would be a non issue if I hadn't made the books display ready before working with them here
    */
    ...
    */
    books.forEach(function(book) {
      var boxToPlaceIn = {'weight': 0, 'boxID': 0}; //holder variable to determine which box is best fit
      var canFit = false; //boolean to determine if the current book will fit in any box
