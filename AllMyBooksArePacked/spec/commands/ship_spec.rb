...
describe ParsePages::Ship do
  ...
  it "should return one box if the total weight is less than the max weight" do
    ...
    answer = {"box" => {"id" => 1, "totalWeight" => 6.8, "contents" => [{"title" => "Zealot: The Life and Times of Jesus of Nazareth", "author" => "Reza Aslan", "price" => "$16.89 USD", "shipping_weight" => "1.2 pounds", "isbn-10" => 140006922}, {"title" => "A New Kind of Science", "author" => "Stephen Wolfram", "price" => "$35.25 USD", "shipping_weight" => "5.6 pounds", "isbn-10" => 1579550088}]}}
